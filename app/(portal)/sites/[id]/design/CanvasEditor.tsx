    ...
    <div className="lg:flex lg:gap-4 lg:items-start rounded-2xl p-3 md:p-4 lg:w-[92vw] lg:ml-[calc(50%-46vw)]" style={{ background: '#f4f4f7' }}>
      ...
      <div className="lg:sticky lg:top-2 lg:shrink-0 flex gap-2.5 mb-4 lg:mb-0">
        ...
        <div className="flex items-center gap-1.5">
          ...
          <button type="button" onClick={() => setSelectedIds(els.map(e => e.id))} disabled={!els.length} title="Select everything on this page — no need to drag a box or zoom out (Ctrl/Cmd+A)" className="flex-1 font-label text-[9px] tracking-[1px] uppercase border border-gold/30 text-gold hover:bg-gold/10 disabled:opacity-40 px-2 py-1.5 rounded-sm whitespace-nowrap">⊞ Select all</button>
